...
export default function Index() {
    ...
    // 提交
    const {mutateAsync:editBook}=useEditBook(['bookmanage','booklist',state.page,state.keyword])
    const handleSubmit= ()=>{
        const value= form.getFieldsValue()
        // console.log(value)
        let data={...value,cover:'picture/'+cover,tags}
    ...
    <div className='vip-detail'>
        ...
        <Form
            ...
            >
                ...
                <Button style={{position:'relative',left:'40%',top:'-3.3rem'}} type='primary' size='small'>
                  读取书籍
                </Button>
                ...
                >
                   <div style={{display:'flex',alignItems:'center',flexWrap:'wrap'}}>
                    {
                      tags.map((item,index)=>
                      <Tag style={{margin:'0.5rem 0.2rem',color:!formDisable?'':'lightgray'}} 

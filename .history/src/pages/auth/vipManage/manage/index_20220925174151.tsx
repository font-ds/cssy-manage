    ...
    <div style={{display:'flex',justifyContent:'space-between'}}>
      <div className='type-button'>
        ...
        <Input.Group className='group' compact>
          ...
          <Input ref={InputRef} onPressEnter={e=>console.log(e.target.value)} style={{ width: '45%',height:'2rem' }}  />
          <img onClick={()=>console.log(InputRef?.current?.input?.value)} src={require('../../../../assets/search.png')} alt='搜索'></img>
        </Input.Group>

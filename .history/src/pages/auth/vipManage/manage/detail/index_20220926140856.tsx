...
export default function Index() {
    ...
    const handleSubmit= async ()=>{
        ...
        console.log(JSON.stringify({...data,vip_id:state.vip_id,}))
        if(JSON.stringify(state)==JSON.stringify(data))
        {
          console.log(JSON.stringify(state))
          console.log(JSON.stringify(data))
          return setFormDisable(true)
        } 
        ...
        <Form
            ...
            >
                ...
                <Form.Item
                  ...
                  rules={[{ required: true, message: '此项不能为空！' }]}
                >
                  <DatePicker disabledDate={disabledDate} style={{width:'14rem'}} placeholder='普通会员请随意填写' onChange={(e,value)=>console.log(e,value)}></DatePicker>
                </Form.Item>
            </Form>

...
export default function Index() {
    ...
    const handleSubmit= async ()=>{
        ...
        let data={
            ...formData,
            // 根据moment属性获取时间戳
            power_expire_date:moment(formData.expired_date).unix()*1000
        }
        ...
        <Form
            ...
            >
                ...
                <Form.Item
                  ...
                  rules={[{ required: true, message: '此项不能为空！' }]}
                >
                  <DatePicker defaultValue={moment('2022/10/12','YYYY/MM/DD')} disabledDate={disabledDate} style={{width:'14rem'}} placeholder='普通会员请随意填写' onChange={(e,value)=>console.log(e,value)}></DatePicker>
                </Form.Item>

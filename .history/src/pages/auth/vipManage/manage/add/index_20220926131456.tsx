...
export default function Index() {
    ...
    // 会员选择类型
    const [vipType,setVipType]=useState<string>('0')
        ...
        <Form
            ...
            >
                ...
                <Form.Item
                  ...
                  rules={[{ required: true, message: '此项不能为空！' }]}
                >
                  <Select placeholder='请选择会员类型' onChange={(e)=>setVipType(e)} style={{ width: '14rem' }}>
                ...
                <Form.Item
                  label="到期时间"
                  name="expired_date"
                  rules={[{ required: vipType=='0'?false:true, message: '此项不能为空！' }]}
                >

...
import {Table,Button,Divider,Popconfirm,PaginationProps,Input,Select,InputRef, message} from 'antd'
...
export default function Index() {
  ...
  <div className='coupon'>
    <div style={{display:'flex',justifyContent:'space-between'}}>
      ...
      <Button size='small' type='primary' onClick={()=>setModalVisible(true)}>优惠券管理</Button>
    </div>

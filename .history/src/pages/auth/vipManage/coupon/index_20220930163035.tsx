...
export default function Index() {
  ...
  // 使用优惠券
  const { mutateAsync: userUseCoupon } = useCoupon([
    "vipmanage",
    "couponRecord",
    page,
    keyword,
  ...
  return (
    <div className="coupon">
        ...
        columns={[
          ...
          },
          {
            ...
            render(value: couponRecord) {
              if (value.state == "1") return <span>已使用</span>;
              if (value.state == "2") return <span>已过期</span>;
      ...
      {modalVisible ? (
        <CouponModal
          controlModal={setModalVisible}
          visible={modalVisible}
          addModal={setAddVisible}
        ></CouponModal>
      ) : null}
      {addVisible ? (
        <AddModal

...
import {Button,Divider,Form,Input,Radio,Upload,Switch, message} from 'antd';
        ...
        <Form
            ...
            >
               ...
               <Form.Item
                  ...
                  rules={[{ required: true, message: '此项不能为空！' }]}
                >   
                  <Input name='cover' value={JSON.stringify(upFileList)} />
                ...
                <Form.Item wrapperCol={{offset:2,span:16}}>
                    ...
                    <Button style={{marginLeft:'2rem'}} size='small' onClick={()=>setUpFileList([{
            status:'done',
            url:'123123'
        }])}>
                        重置

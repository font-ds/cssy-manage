        ...
        <Form
            ...
            >
                ...
                <Form.Item wrapperCol={{offset:2,span:16}}>
                    ...
                    <Button style={{marginLeft:'1rem',marginRight:'1rem'}} htmlType="reset" size='small' >
                        重置
                    </Button>
                    <Switch checkedChildren="开启" unCheckedChildren="关闭" defaultChecked onChange={e=>console.log(e)} />
                    保存后自动进入下一本
                </Form.Item>
            </Form>
    </div>

...
import { uploadImageBtn } from "../util";
  ...
  return (
    <div className="add-book">
      ...
      >
        ...
        <Button
          style={{ position: "relative", left: "40%", top: "-3.3rem" }}
          type="primary"
          size="small"
        >
          读取书籍
          ...
          >
            {tags.map((item, index) => (
              <Tag
                ...
                closable={!disabled}
                onClose={() => {
                  let newTags = tags.splice(0, index);
                  setTags(newTags);
                }}
                key={index}
              >

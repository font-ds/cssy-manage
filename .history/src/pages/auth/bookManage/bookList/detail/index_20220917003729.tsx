    ...
    <div className='vip-detail'>
        ...
        <Form
            ...
            >
                ...
                <Col span={8} offset={2} style={{display:'flex'}}>
                  <Form.Item  label="图书ISBN" rules={[{ required: true, message: '此项不能为空！' }]}  name='isbn' >
                    <Input  /> 
                  </Form.Item>
                  <Button style={{marginLeft:'3%'}} size='small'>读取书籍</Button>
                </Col>
                <Form.Item
                  label="书籍封面"
                  name="cover"

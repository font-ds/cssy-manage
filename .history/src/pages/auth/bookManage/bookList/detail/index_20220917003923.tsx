    ...
    <div className='vip-detail'>
        ...
        <Form
            ...
            >
                ...
                <Col  offset={2} style={{display:'flex',justifyContent:'left'}}>
                  <Form.Item style={{width:'100%',backgroundColor:'reds'}} label="图书ISBN" rules={[{ required: true, message: '此项不能为空！' }]}  name='isbn' >

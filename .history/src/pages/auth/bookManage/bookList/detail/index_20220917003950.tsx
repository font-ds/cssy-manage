    ...
    <div className='vip-detail'>
        ...
        <Form
            ...
            >
                ...
                <Col  offset={0.5} style={{display:'flex',justifyContent:'left'}}>
                  <Form.Item style={{width:'100%',backgroundColor:'red'}} label="图书ISBN" rules={[{ required: true, message: '此项不能为空！' }]}  name='isbn' >
                    <Input style={{width:'70%'}} /> 
                  </Form.Item>
                  <Button  size='small'>读取书籍</Button>
                </Col>
                <Form.Item
                  label="书籍封面"
                  name="cover"

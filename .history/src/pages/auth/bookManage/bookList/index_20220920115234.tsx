...
export default function Index() {
  ...
  // 获取数据
  const {isLoading,data:users}=useGetBookList(page)
  // 确认删除
  const {mutateAsync:delBook}=useDelBook(['bookmanage','booklist'])
              ...
              return (
                <>
                  ...
                  <Popconfirm
                      ...
                      cancelText="取消"
                    >
                    <Button type='link' danger onClick={() => {console.log('删除',value)}}>删除</Button>
                  </Popconfirm>

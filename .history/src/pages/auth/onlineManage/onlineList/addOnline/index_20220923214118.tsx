...
import {uploadImageBtn,handleImgUrl} from '../../../bookManage/util'
        ...
        <Form
            ...
            >
                ...
                <Form.Item  wrapperCol={{offset:3}}>
                    ...
                    <Button style={{marginRight:'1rem',marginTop:'2rem'}} type="primary" htmlType="submit">
                      新增
                    </Button>
                    <Button style={{marginLeft:'1rem'}} type="primary" onClick={()=>navigate(-1)}>
                      取消
                    </Button>
                </Form.Item>
            </Form>

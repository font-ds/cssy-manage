...
import {uploadImageBtn,handleImgUrl,uploadVedioBtn,handleVideoUrl} from '../../../bookManage/util'
...
export default function Index() {
    ...
    useEffect(()=>{
      ...
      handleVideoUrl(state.cover,setKeyFileList,state.title)
    },[])
    // 提交
        ...
        <Form
            ...
            >
                ...
                >
                  ...
                  <Video url={keyFileList[0]?.url}></Video>
                  <video>
                    <source src={'../../../../../../../../../../guanyifang/Desktop/5.5/Simulator Screen Recording - iPhone 8 Plus - 2022-09-07 at 12.23.19.mp4'} type="video/mp4"  />
                  </video>
                </Form.Item>
                <Form.Item
                  label="视频状态"

                  ...
                  <Popconfirm
                      ...
                      title={
                        <div>
                          ...
                          <div>
                            <Button style={{margin:'1rem 1rem'}}>1周</Button>
                            <Button style={{margin:'1rem 1rem'}}>2周</Button>
                            <Button style={{margin:'1rem 1rem'}}>3周</Button>
                            <Button style={{margin:'1rem 1rem'}}>4周</Button>
                          </div>
                        </div>
                      }
                      onConfirm={()=>changeLeadRecord(value)}

...
const getLeadRecord=(page:any,state:any)=>{
    return request(`http://127.0.0.1:4523/m1/1513755-0-default/back/borrow?page=${page}&state=${state}&limit=1`)
}
...
export const useGetLeadRecordAll=(page:any,state:any)=>{
    return useQuery(['leadmanage','leadrecordlist',page,state],async ()=>{
        ...
        let data={pagination:{totle:10,pageSize:1,current:1},data:res.data}
        return data

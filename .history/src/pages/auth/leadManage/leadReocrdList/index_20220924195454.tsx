                  ...
                  <Popconfirm
                      ...
                      title={
                        <div>
                          ...
                          <div>
                            <Button type={longer==1?'primary':'default'} style={{margin:'1rem 0.5rem'}}>1周</Button>
                            <Button type={longer==2?'primary':'default'} style={{margin:'1rem 0.5rem'}}>2周</Button>
                            <Button type={longer==3?'primary':'default'} style={{margin:'1rem 0.5rem'}}>3周</Button>
                            <Button type={longer==4?'primary':'default'} style={{margin:'1rem 0.5rem'}}>4周</Button>
                          </div>
                        </div>
                      }
                      onConfirm={()=>changeLeadRecord(value)}

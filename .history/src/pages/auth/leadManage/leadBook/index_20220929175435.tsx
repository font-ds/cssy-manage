...
export default function Index() {
  ...
  const readBook = () => {
    ...
    getOneBook(bookId, dispatch).then((res) => {
      console.log(res);
      ...
      >
        ...
        >
          <Input
            ...
            maxLength={11}
            minLength={11}
            placeholder="会员手机号(限11位)"
          />
        </Form.Item>
        <Form.Item label="会员姓名" name="vip_name">
          <Input
            disabled
        ...
        <Form.Item label="书籍名称" name="title">
          <Input
            disabled
            style={{ border: "0", backgroundColor: "white", color: "black" }}
          ></Input>
        ...
        <Form.Item label="书籍分类" name="tags">
          {tags.map((item, index) => (
            <Tag key={index}>{item}</Tag>
          ))}
        </Form.Item>
        <Form.Item label="书籍语言" name="language">
          <Input
            disabled
            style={{ border: "0", backgroundColor: "white", color: "black" }}
          ></Input>
        </Form.Item>
        <Form.Item label="出版社" name="publish_by">
          <Input
            disabled
            style={{ border: "0", backgroundColor: "white", color: "black" }}
          ></Input>
        </Form.Item>
        <Form.Item label="借阅权限" name="permission">
          <Input
            disabled
            style={{ border: "0", backgroundColor: "white", color: "black" }}
          ></Input>

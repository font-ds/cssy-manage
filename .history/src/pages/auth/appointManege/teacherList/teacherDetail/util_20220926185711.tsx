...
export const changeOnlineTime=(params:changeTimeConfig)=>{
    ...
    return request(
        `http://127.0.0.1:4523/m1/1513755-0-default/back/tutor/period?date=${params.date}&peirod=${params.peirod}&to_state=${params.to_state}&tutor_id=DS${params.tutor_id}`,
        {
            method:'put',
            token:token
        }
...
export const formDataTime=(index:any)=>{
    ...
    return `${checkedTimer.getFullYear()}/${checkedTimer.getMonth()}/${checkedTimer.getDate()}`
}
...
import {Button,Divider,Form,Input,FormInstance,DatePicker, message,Popconfirm,Radio,Select,Upload} from 'antd';
...
export default function Index() {
  ...
  return (
    ...
    >
        ...
        >
          <Select onChange={e=>setType(e)}  style={{ width: '14rem' }}>

        ...
        <Form
            ...
            >
                ...
                <Form.Item
                  ...
                  rules={[{ required: true, message: '此项不能为空！' }]}
                >
                  <DatePicker size='small' placeholder='请选择日期' onChange={(e,value)=>console.log(e,value)}></DatePicker>
                  <TimePicker.RangePicker style={{marginTop:'1rem'}} placeholder={['开始时间','结束时间']} format='hh:mm' size='small' />
                </Form.Item>
                <Form.Item
                  label="预约人数"
                  name="maximum"
